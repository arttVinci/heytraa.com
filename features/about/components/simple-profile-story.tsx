  ...
  return (
    <section className="rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white/95 dark:bg-slate-900/90 backdrop-blur-md p-5 sm:p-6 md:p-7 shadow-2xs transition-colors duration-200">
      ...
      <div className="space-y-3 text-sm sm:text-base text-slate-600 dark:text-slate-300 leading-relaxed sm:leading-7">
        ...
        <p>
          {lang === "id"
            ? "Selain itu, Putra Rizky Nugraha juga aktif mengeksplorasi integrasi AI/LLM ke dalam sistem yang dibangun, termasuk implementasi Retrieval-Augmented Generation (RAG) dan vector database, yang dikembangkan melalui proyek open-source pribadi. Beberapa proyek yang saat ini sedang dikerjakan meliputi aplikasi asisten percakapan AI untuk pelaporan kendala infrastruktur dengan backend Go/Fiber dan integrasi LangGraph, serta bereksperimen membangun tool AI coding CLI sendiri dan infrastruktur self-hosted untuk mendeploy produk yang dikembangkan."
            : "Beyond that, Putra Rizky Nugraha is also actively exploring AI/LLM integration into the systems I build, including implementing Retrieval-Augmented Generation (RAG) and vector databases, which I've developed through a personal open-source project. Some of the projects I'm currently working on include an AI conversational assistant app for reporting infrastructure issues, with a Go/Fiber backend and LangGraph integration, as well as experimenting with building my own AI coding CLI tool and self-hosted infrastructure for deploying the products I develop."}
        </p>

        <p>
          {lang === "id"
            ? "Putra Rizky Nugraha adalah seorang pembelajar mandiri yang terbiasa mengeksplorasi teknologi baru secara independen, serta memiliki komitmen penuh untuk membangun karier jangka panjang sebagai Software Engineer profesional."
            : "Putra Rizky Nugraha is a self-driven learner, accustomed to exploring new technologies independently, and fully committed to building a long-term career as a professional Software Engineer."}
        </p>
      </div>
    </section>
  );
