        ...
        {simpleEducationData.map((edu) => {
          ...
          return (
            ...
            >
              ...
              {isExpanded && (
                <div className="mt-4 pt-4 border-t border-slate-100 dark:border-slate-800/80 space-y-3.5 animate-in fade-in-50 duration-200">
                  <p className="text-sm sm:text-[15px] text-slate-600 dark:text-slate-300 leading-relaxed">
                    {edu.description[lang]}
                  </p>

                  <div className="space-y-2">
                    <div className="flex items-center gap-1.5 text-xs sm:text-[13px] font-mono font-bold uppercase tracking-wider text-[#689F99] dark:text-[#88C0B9] pt-1">
