    ...
    <section className="space-y-4 sm:space-y-5">
      ...
      <div>
        <div className="flex items-center gap-2">
          <Briefcase className="w-5 h-5 text-[#689F99]" />
        ...
        {simpleExperienceData.map((exp) => {
          ...
          return (
            ...
            >
              ...
              {isExpanded && (
                <div className="mt-3.5 pt-3.5 border-t border-slate-100 dark:border-slate-800/80 space-y-4 animate-in fade-in-50 duration-200">
                  {/* 1. TUGAS */}
                  <div className="space-y-2">
                    <div className="flex items-center gap-1.5 text-[11px] font-mono font-bold uppercase tracking-wider text-[#689F99] dark:text-[#88C0B9]">
